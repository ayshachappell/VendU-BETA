    ...
    return [
      {
        ...
        text: "A short guided tour on the real app — you tap along. Replay it anytime from Profile → Settings → Tutorial.",
        next: "Show me around",
      },
      {
        before: goHome,
        ...
        text: "Use the floating search to find students and services. Tap the frosted school pill to browse another campus; posting still follows the campus currently selected.",
        place: "below",
      },
      {
        before: goHome,
      ...
      },
      {
        ...
        text: "Feed is what students are posting now, Browse lists every hustle and storefront, and Events shows what's happening on campus. Pull down to refresh any of these three areas.",
...

      {
        ...
        text: "🎓 Charter is one of the first 10 verified vendors on a campus, 💠 Vendor sells, ★ is The VendU App staff, and campus or community badges show where they belong. 🏷️ Sale, 🏷️ 20% off and ⏳ Ending soon show while a promo is running. Posts show up to two.",
        place: "below",
      },
      {
        before: goBrowse,
...

      {
        ...
        text: "Market is where students buy items or post trades, requests, housing and jobs. Pull down to refresh Buy or Trade & Requests. The ＋ button posts a service, item, trade, request or campus event — add photos, then delete or mark sold anytime.",
        doit: "Tap ＋",
        click: true,
        place: "above",
      },
