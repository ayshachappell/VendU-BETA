  ...
  function steps() {
    return [
      ...
      },
      {
        ...
        text: "Your circular profile photo opens messages and campus event updates. Until you add a photo, a bell appears instead. The red badge is your live unread total.",
        place: "below",
      },
      {
        before: goHome,
